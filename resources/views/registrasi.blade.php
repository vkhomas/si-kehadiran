                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="POST" role="form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>NIM</label>
                                            <input id="nim" class="form-control" name="nim" required>
                                        </div>
                                        @if ($errors->has('nim'))
                                            <span class="help-block" style="color:red">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id = "dosbing" class="form-control" name="dosbing" ascending required>
                                            @foreach ($userDosen as $dos)
                                                <option>{{$dos->kk}} - {{$dos->name1}}</option>
                                            @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Judul Riset</label>
                                            <input id="judul_riset" class="form-control" name="judul_riset" required>
                                        </div>
                                        <div class="form-group">
